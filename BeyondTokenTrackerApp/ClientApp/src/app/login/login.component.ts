      ...
      .subscribe(
        user => {
          setTimeout(() => {
            ...
            if (!this.isModal) {
              this.alertService.showMessage('Login', `Welcome ${user.name}!`, MessageSeverity.success);
            } else {
              this.alertService.showMessage('Login', `Session for ${user.name} restored!`, MessageSeverity.success);
              setTimeout(() => {
