...
export class NotificationsViewerComponent implements OnInit, OnDestroy {
  ...
  constructor(private alertService: AlertService, private accountService: UserService, private notificationService: NotificationService) {
  }
  ...
  get canManageNotifications() {
    return true; // Todo: Consider creating separate permission for notifications
  }
