...
export class AlertService {
  //private clearCommand: AlertCommand = {
  //  operation: 'clear', message: ''
  //};
  private clearCommand: AlertCommand = {
    operation: 'clear',
    message: { severity: MessageSeverity.default, summary: '', detail: '' },
    onRemove: null
  };
  ...
  showMessage(data: any, separatorOrDetail?: string, severity?: MessageSeverity) {
    ...
    if (data instanceof Array) {
      ...
      console.log('NOT data instanceof Array');
  ...
  resetStickyMessage() {
    this.messages.next(this.clearCommand);
  }
